...
import { CallExpressionContext, SingleExpressionContext } from '../grammar/src/grammar/lib/epScriptParser';
import { ProviderOption } from './provider-option';

export function provideSingatureHelp({contextPackage, name, params}: ProviderOption<SignatureHelpParams>, evaluated: Literal, singleExpression: SingleExpressionContext): SignatureHelp {
	...
	console.log(evaluated, singleExpression);
