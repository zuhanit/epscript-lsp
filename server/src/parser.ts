...
import { CodePointCharStream, CharStreams, CommonTokenStream, CommonToken, Recognizer, RecognitionException, Token } from 'antlr4ts';
...
import { epScriptParser, ProgramContext } from './grammar/src/grammar/lib/epScriptParser';
...
export class Parser {
		...
		): ParsePackage
	{
		...
		const listener = new BaseListener(this, document, folderPath, analyzer, diagnostics, languageManager);
