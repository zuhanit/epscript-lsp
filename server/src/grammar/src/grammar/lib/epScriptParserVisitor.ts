 ...
 */
export interface epScriptParserVisitor<Result>
   ...
   * @return the visitor result
   */
  visitNumericLiteralExpression?: (
    ctx: NumericLiteralExpressionContext
  ) => Result;
   ...
   * @return the visitor result
   */
  visitParanthesizedExpression?: (
    ctx: ParanthesizedExpressionContext
  ) => Result;
  ...
  visitVariableDeclarationList?: (
    ctx: VariableDeclarationListContext
  ) => Result;
   ...
   * @return the visitor result
   */
  visitObjectVariableDeclaration?: (
    ctx: ObjectVariableDeclarationContext
  ) => Result;
