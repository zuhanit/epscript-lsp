...
export const builtinClasses: BuiltinClass[] = [
  ...
  },
  {
    ...
    init: {
      args: ["baseobj", "offset=0", "rlocmode=4"],
      doc: "",
    },
  },
  {
  ...
  },
  {
    ...
    methods: [
      ...
      {
        name: "check_status_flag",
        args: ["value", "mask=None"],
        doc: "",
      },
      {
        name: "clear_gathering",
        args: [""],
        doc: "",
      },
      {
        name: "clear_hallucination",
        args: [""],
        doc: "",
      },
      {
        name: "clear_invincible",
        args: [""],
        doc: "",
      },
      {
      ...
      {
        name: "clear_speed_upgrade",
        args: [""],
        doc: "",
      },
      {
        name: "clear_status_flag",
        args: ["mask"],
        doc: "",
      },
      {
  ...
  },
  {
    ...
    methods: [
      ...
      {
        name: "find_spec",
        args: ["fullname", "path", "target=None"],
        doc: "",
      },
    ],
    doc: "",
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        args: ["source_path", "bytecode_path", "data"],
        doc: "",
      },
      {
        name: "create_module",
      ...
      {
        name: "set_data",
        args: ["path", "data", "*", "_mode=438"],
        doc: "Write bytes data to a file.",
      },
      {
        name: "source_to_code",
        args: ["data", "path", "*", "_optimize=-1"],
        doc: "",
      },
    ],
    doc: "",
  ...
  },
  {
    ...
    doc: "",
    init: {
      args: ["argn", "callerfunc", "bodyfunc", "*", "traced"],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        name: "iinvert",
        args: [""],
        doc: "In-place invert (x << ~x)",
      },
      {
        name: "ineg",
        args: [""],
        doc: "In-place negate (x << -x)",
      },
    ],
    doc: "",
    init: {
  ...
  },
  {
    ...
    methods: [
      ...
      {
        name: "seek",
        args: ["varr_ptr", "varr_epd", "eudv", "acts=[]"],
        doc: "",
      },
    ],
    doc: "",
  ...
  },
  {
    ...
    methods: [
      ...
      {
        name: "fill",
        args: ["values", "*", "assert_expected_values_len=None"],
        doc: "",
      },
      {
        name: "get",
    ...
    doc: "",
    init: {
      args: ["initvars=None", "*", "dest=0", "nextptr=0", "_from=None"],
      doc: "",
    },
  },
  {
  ...
  },
  {
    ...
    methods: [
      ...
      {
        name: "tagprint",
        args: ["format_string", "*args", "line=-1", "tag=None"],
        doc: "",
      },
      {
        name: "CPBranch",
  ...
  },
  {
    ...
    doc: "",
    init: {
      args: ["content=None", "init_chkt=None", "load_entry=2", "save_entry=4"],
      doc: "",
    },
  },
  {
